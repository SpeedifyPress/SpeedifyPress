...
class Debug {
	...
	private static function log_trace($message, $backtrace)
	{
		...
		foreach($backtrace as $caller)
		{
			...
			// Stop at the first caller that isn't part of SPRESS\Dependencies\simplehtmldom
			if (!isset($caller['class']) || strpos($caller['class'], 'SPRESS\Dependencies\simplehtmldom\\') !== 0) {
				break;
			}
		}
